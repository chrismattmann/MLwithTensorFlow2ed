...
pushd data
unzip User*.zip &&  rm -rf __MACOSX/ && rm -rf User*.zip
popd
echo "...done"
...
pushd data
tar xvzf cifar-10-python.tar.gz && rm -rf cifar-10-python.tar.gz
popd
echo "...done"
...
pushd data
tar xvf vgg_face_dataset.tar.gz && rm -rf vgg_face_dataset.tar.gz
popd
...
pushd data
unzip vgg-models.zip && rm -rf vgg-models.zip
popd
...
unzip cloth_folding_vids.zip && rm -rf cloth_folding_vids.zip
popd
